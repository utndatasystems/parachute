# Adapted from: https://github.com/learnedsystems/CEB.

import networkx as nx
from networkx.readwrite import json_graph

from query_representation.query_utils import extract_join_graph, generate_subset_graph
import time
import itertools
import json
import pdb
...
def load_qrep(fn):
    ...
    if 'subset_graph' in query and query['subset_graph'] is not None:
...
def save_qrep(fn, cur_qrep):
    ...
    if 'subset_graph' in qrep and qrep['subset_graph'] is not None:
